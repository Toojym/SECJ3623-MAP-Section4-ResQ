...
class AwanisService {
  ...
  Future<String> chatWithCitizen(String message) async {
    ...
    if (lowerMsg.contains("banjir") || lowerMsg.contains("air naik") || lowerMsg.contains("flood")) {
    ...
    } else if (lowerMsg.contains("pusat pemindahan") || lowerMsg.contains("shelter") || lowerMsg.contains("pps")) {
    ...
    } else if (lowerMsg.contains("tuntutan") || lowerMsg.contains("bantuan") || lowerMsg.contains("claim")) {
    ...
    } else if (lowerMsg.contains("hai") || lowerMsg.contains("hello") || lowerMsg.contains("salam")) {
    ...
    } else if (lowerMsg.contains("hospital") || lowerMsg.contains("ambulans") || lowerMsg.contains("kkm") || lowerMsg.contains("klinik") || lowerMsg.contains("kecemasan perubatan")) {
    ...
    } else if (lowerMsg.contains("jkm") || lowerMsg.contains("jabatan kebajikan")) {
    ...
    } else if (lowerMsg.contains("apm") || lowerMsg.contains("pertahanan awam")) {
    ...
    } else if (lowerMsg.contains("jkr") || lowerMsg.contains("tanah runtuh") || lowerMsg.contains("jalan ditutup") || lowerMsg.contains("jalan raya")) {
...
Terus berhubung melalui sistem pemantauan SIGAP dan tunggu arahan selanjutnya daripada pegawai bertugas.''';
  ...
  Future<String> queryOfficerAnalytics(String question, Map<String, dynamic> firestoreData) async {
    ...
    } else if (lowerQ.contains('tuntutan') || lowerQ.contains('claim') || lowerQ.contains('bwi') || lowerQ.contains('dana')) {
    ...
    } else if (lowerQ.contains('laporan') || lowerQ.contains('analisa') || lowerQ.contains('trend')) {
    ...
    } else if (lowerQ.contains('mangsa') || lowerQ.contains('gombak') || lowerQ.contains('jumlah mangsa')) {
    ...
    } else if (lowerQ.contains('hai') || lowerQ.contains('hello') || lowerQ.contains('salam')) {
